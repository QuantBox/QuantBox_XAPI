...
{
    DFITCSOPSpecificDataField            specificDataField;        //特有的
    DFITCStaticDataField                 staticDataField;          //共有的静态
    DFITCSharedDataField                 sharedDataField ;         //公有的动态 
...
{
	DFITCSharedDataField                 sharedDataField ;        //公有的动态 
    DFITCStockSpecificDataField          specificDataField;       //特有的
    DFITCStaticDataField                 staticDataField;         //共有的静态
